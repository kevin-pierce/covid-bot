    ...
    async execute(message, args){
        ...
        // Data for TODAY
            ...
            // Country-specific deaths TODAY
                ...
                message.channel.send(`Today, ${numberWithCommas(totalTodayDeathsCountry)} people have died due to COVID-19 in ${info["country"]}.`);
            }
        }
        // The user specifies their search for YESTERDAY
            ...
            // Country-specific deaths YESTERDAY
                ...
                message.channel.send(`Yesterday, ${numberWithCommas(totalYTDDeathsCountry)} people died due to COVID-19 in ${info["country"]}.`);
            }
            else {
